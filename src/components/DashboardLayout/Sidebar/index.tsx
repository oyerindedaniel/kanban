            ...
            {LINKS.map((link, Idx) => {
              ...
              return (
                <Link href={link.url} key={link.name} className="hover:fill-brand-iris">
                  <div
                    className={cn(
                      'duration-150 mb-0 flex cursor-pointer items-center justify-start gap-2 px-4 py-3 transition-all ease-in-out hover:bg-gray-200 hover:text-brand-iris md:justify-center xl:justify-start  rounded-r-[100px] text-[15px] font-bold text-brand-regent-grey rounded-b-[100px]xl:px-4 xl:py-2',
