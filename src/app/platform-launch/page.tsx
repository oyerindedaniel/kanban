    ...
    <>
      {ITEMS > 0 ? (
        <div className="grid grid-cols-4 gap-8 w-[1250px]">
          ...
          <Platform /> */}
          {/* <Platform /> */}
          <div className="h-[360px] w-72 bg-gradient-to-b from-brand-sky-blue/100 to-brand-light-blue/50 justify-center flex rounded-md cursor-pointer mt-12">
            <p
        ...
        <div className="py-auto flex flex-col items-center justify-center h-[75vh]">
          ...
          <Button
            className="mt-8 dark:text-white bg-brand-iris rounded-[100px] hover:bg-brand-biloba-flower hover:text-white"
            onClick={handleAddNewColumn}
          >
            + Add New Column
          </Button>
